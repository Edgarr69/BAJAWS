...
export default function Header() {
  ...
  return (
    <>
      <header
        className={`sticky top-0 z-50 w-full bg-gradient-to-br from-primary-900 via-primary-800 to-slate-900 transition-[box-shadow,border-color] duration-300 border-b ${
