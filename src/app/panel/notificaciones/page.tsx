...
const createNotificationEmail = (body: { email: string; label?: string }) =>
  apiFetch<NotificationEmail>('/api/admin/notification-emails', {
    method: 'POST',
...
const toggleNotificationEmail = (id: string, is_active: boolean) =>
...
const deleteNotificationEmail = (id: string) =>
...
export default function NotificacionesPage() {
  ...
  useEffect(() => {
    getNotificationEmails()
      ...
      .catch(() => toast.error('Error cargando correos de notificación'))
