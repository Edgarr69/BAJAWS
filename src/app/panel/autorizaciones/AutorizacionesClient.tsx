...
import { createAutorizacion, updateAutorizacion, deleteAutorizacion } from '@/lib/api';
...
export function AutorizacionesClient({ initialRows }: { initialRows: Autorizacion[] }) {
  const [rows, setRows]         = useState<Autorizacion[]>(initialRows);
