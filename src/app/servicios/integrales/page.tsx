...
function StepCard({ step, delay }: { step: typeof steps[number]; delay: number }) {
  ...
  return (
    <AnimateOnScroll delay={delay} direction="up" once={false} rootMargin={ROOT_MARGIN_FIXED}>
      <div
        className="group relative bg-white rounded-2xl border-t-4 shadow-sm hover:-translate-y-1.5 hover:shadow-[0_10px_28px_rgba(0,0,0,0.09)] transition-[transform,box-shadow] [transition-duration:250ms] ease-out p-3 sm:p-5 h-full flex flex-col gap-2 sm:gap-3 overflow-hidden"
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
            ...
            },
            {
              ...
              "provider": { "@type": "Organization", "@id": "https://bajaws.com.mx/#organization", "name": "Baja Wastewater Solution" },
