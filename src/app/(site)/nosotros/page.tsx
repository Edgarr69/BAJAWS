...
export default function NosotrosPage() {
  ...
  return (
    <>
      {/* Encabezado de página — elegante sin color */}
      <div className="bg-gradient-to-b from-slate-50 to-white border-b border-slate-100 py-5 sm:py-7">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-1">
          <p className="text-xs font-semibold uppercase tracking-widest text-emerald-700 mb-3">La empresa</p>
      ...
      <Section>
        <div className="max-w-5xl mx-auto">
          ...
          {/* Historia — texto + imagen laboratorio */}
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-14 items-start mb-14">
